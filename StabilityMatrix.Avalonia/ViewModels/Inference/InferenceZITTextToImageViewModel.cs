...
[ManagedService]
[RegisterScoped<InferenceZITTextToImageViewModel>]
public class InferenceZITTextToImageViewModel : InferenceGenerationViewModelBase, IParametersLoadableState
{
    ...
    public ZImageModelCardViewModel ModelCardViewModel { get; }
    ...
    public InferenceZITTextToImageViewModel(
        ...
        : base(vmFactory, inferenceClientManager, notificationService, settingsManager, runningPackageService)
    {
        ...
        ModelCardViewModel = vmFactory.Get<ZImageModelCardViewModel>();
        ...
        ModulesCardViewModel = vmFactory.Get<StackEditableCardViewModel>(modulesCard =>
        {
            modulesCard.AvailableModules = new[]
            {
                ...
                typeof(ZImageHiresFixModule),
                typeof(SaveImageModule),
                typeof(UpscalerModule),
            };
            modulesCard.DefaultModules = new[] { typeof(ZImageHiresFixModule), typeof(UpscalerModule) };
