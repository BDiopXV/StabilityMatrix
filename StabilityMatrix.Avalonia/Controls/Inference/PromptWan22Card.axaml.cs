...
[RegisterTransient<PromptWan22Card>]
public class PromptWan22Card : TemplatedControlBase
{
    /// <inheritdoc />
    ...
    {
        if (DataContext is not PromptWan22CardViewModel { IsNegativePromptEnabled: false })
        {
            return;
        }
